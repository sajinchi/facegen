...
import SubscriptionViewPageSingle from '@/components/subscription/subscriptionViewPageSingle'
import Topbar from '@/components/topbar/page'
import Authorization from '@/hocs/withAuth.hoc'
import React from 'react'

const SubscriptionViewSingle = () => {
  return (
    <Authorization>
      ...
      <div className="flex flex-row">
        ...
        <div className="grow flex flex-col">
          ...
          <div className=" w-1166 h-auto shadow-md m-auto mt-5 bg-white">
            ...
            <SubscriptionViewPageSingle></SubscriptionViewPageSingle>
          </div>
        </div>
      </div>
    </div>
...
export default SubscriptionViewSingle
